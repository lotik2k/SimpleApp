...
class SearchFragment : BaseFragment(), SearchView, OnMapReadyCallback {
    ...
    @ProvidePresenter
    fun createPresenter(): SearchPresenter {
        return presenter
    }
    ...
    override fun initUI() {
        ...
        from_text.setOnClickListener { presenter.onFromClicked() }
        to_text.setOnClickListener { presenter.onToClicked() }
        there_text.setOnClickListener { presenter.onDateClicked() }

        from_text.setOnClickListener { presenter.onFromClicked() }
        to_text.setOnClickListener { presenter.onToClicked() }

        passengers_text.setOnClickListener { presenter.onPassengersClicked() }
...
//        startAnimation(latLngFrom)
    ...
    private fun startAnimation(latLngFrom: LatLng) {
        ...
        outerParams.leftMargin = screenPosition.x - 32.toPx()
        outerParams.topMargin = screenPosition.y - 32.toPx()
        ...
        innerParams.leftMargin = screenPosition.x - 16.toPx()
        innerParams.topMargin = screenPosition.y - 16.toPx()
